                ...
                <form action="" method="POST" enctype="multipart/form-data" id="formautoreply">
                   ...
                   @if(Session::has('selectedDevice'))
                    ...
                    <div class="form-group">
                        ...
                        <input type="radio" value="Equal" name="type_keyword" checkedx` class="mr-2"><label class="form-label">Equal</label>
                        <input type="radio" value="Contain" name="type_keyword"><label class="form-label">Contains</label>
                    </div>
                    <div class="form-group">
                        <label for="keyword" class="form-label">Only reply when sender is </label><br>
                        <input type="radio" value="Group" name="reply_when" class="mr-2"><label class="form-label">Group</label>
                        <input type="radio" value="Personal" name="reply_when"><label class="form-label">Personal</label>
                        <input type="radio" value="All" checked name="reply_when"><label class="form-label">All</label>
                    </div>
